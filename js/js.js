...
function actualizar_estado_envio(codigo_envio)
{
    ...
    jQuery.ajax({
        type: "POST",
        url: "{$grupoimpultecajaxcontrollerlink|escape:'htmlall':'UTF-8'}&action=actualizar_estado_pedido",
        data: {
...
{
    url_guardar_configuracion = "{$grupoimpultecajaxcontrollerlink|escape:'htmlall':'UTF-8'}&action=guardar_configuracion";
